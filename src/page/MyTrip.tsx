...
export default function MyTrips() {
  const isCreateTripModalOpen = useMyTripStore(
    (state) => state.isCreateTripModalOpen,
  )
  const setIsCreateTripModalOpen = useMyTripStore(
    (state) => state.setIsCreateTripModalOpen,
  )
